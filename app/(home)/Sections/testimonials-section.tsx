...
const AvatarSVG = ({ bgColor = '#4F46E5', className = '' }) => (
  <div className={`relative ${className} group`}>
    <div className="absolute inset-0 bg-gradient-to-r from-pink-500/30 to-purple-500/30 rounded-full blur-xl group-hover:blur-2xl transition-all duration-300" />
    <svg
      viewBox="0 0 64 64"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M48 48C48 41.3726 40.8366 36 32 36C23.1634 36 16 41.3726 16 48"
        stroke="white"
        strokeWidth="4"
        strokeLinecap="round"
      />
...
export function TestimonialsSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(#e5e7eb_1px,transparent_1px),linear-gradient(to_right,#e5e7eb_1px,transparent_1px)] [background-size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,transparent,#000)] opacity-70" />
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Discover how AI-powered course recommendations helped these
          ...
          {isClient && (
            ...
            >
              {testimonials.map((testimonial, i) => (
                <SwiperSlide key={i as number} className="py-12">
                  <motion.div
                    initial={{ opacity: 0 }}
